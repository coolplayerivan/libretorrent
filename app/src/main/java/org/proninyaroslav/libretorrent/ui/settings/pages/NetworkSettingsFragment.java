...
public class NetworkSettingsFragment extends CustomPreferenceFragment
    ...
    private final Runnable refreshStatus = new Runnable() {
        @Override public void run() {
            Preference status = findPreference("pref_key_proton_port_forwarding_status");
            if (status != null) {
                status.setSummary(TorrentEngine.getInstance(requireContext().getApplicationContext())
                        .protonPortForwardingStatus());
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SwitchPreferenceCompat proton = findPreference(getString(R.string.pref_key_proton_port_forwarding));
        if (proton != null) {
            proton.setChecked(pref.protonPortForwarding());
            bindOnPreferenceChangeListener(proton);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        } else if (preference.getKey().equals(getString(R.string.pref_key_proton_port_forwarding))) {
            pref.protonPortForwarding((boolean) newValue);
